...
- Mengetahui [HTML & CSS](https://internetingishard.com/)
- Mengetahui dasar dari [JavaScript](/javascript-day-one/)
- Terbiasa dengan penulisan [syntax dan features ES6+](/es6-syntax-and-feature-overview/)
- Sudah terinstall [Node.js and npm](/how-to-install-and-use-node-js-and-npm-mac-and-windows/) (atau yarn) secara global

#### Tujuan

Kedepannya kita akan membuat aplikasi menggunakan Vue berupa database pegawai sederhana dan yang akan kita pelajari adalah:
...
Untuk live demo dan source codenya ada di link berikut.

- [Demo](https://azemoning.github.io/vue-tutorial/)
- [Source](https://github.com/azemoning/vue-tutorial)
